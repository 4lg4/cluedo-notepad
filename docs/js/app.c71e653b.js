  ...
  "56d7": function(e, t, n) {
    ...
    var k = new v["a"].Store({
        state: {
          ...
          characters: b.get("characters") || y,
          weapons: b.get("weapons") || w,
          places: b.get("places") || _,
      ...
      C = {
        ...
        methods: Object(j["a"])({}, Object(v["b"])(["setAnswer"])),
        created: function() {}
      },
      S = C,
      ...
      $ = {
        ...
        computed: Object(j["a"])({}, Object(v["c"])(["players"])),
        created: function() {
          this.thePlayers = this.players;
        },
        methods: Object(j["a"])({}, Object(v["b"])(["setPlayers"]), {
      ...
      L = $,
      T = Object(l["a"])(L, I, M, !1, null, null, null),
      N = T.exports;
    a["default"].use(f["a"]);
    var D = new f["a"]({
      routes: [
        { path: "/", name: "home", component: E },
        { path: "/config", name: "config", component: N },
        {
          path: "/about",
          name: "about",
          component: function() {
...
//# sourceMappingURL=app.c71e653b.js.map
